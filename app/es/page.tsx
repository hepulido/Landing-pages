  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="mb-16 sm:mb-20 text-center px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Para quién es</h2>
        ...
        <div className="mt-16 sm:mt-20 px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-8 sm:mb-12">Cómo Funciona</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">¿Llamada perdida? Enviamos SMS automático</h3>
              <p className="text-sm sm:text-base text-gray-600">Enviamos SMS automático al llamante para que no pierdas el lead.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Buzón de voz a resumen</h3>
              <p className="text-sm sm:text-base text-gray-600">Transcribimos y detectamos la intención (ej., &ldquo;emergencia&rdquo;, &ldquo;solicitud de cotización&rdquo;).</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Alertas prioritarias</h3>
              <p className="text-sm sm:text-base text-gray-600">Te decimos a quién llamar primero para ganar el trabajo.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 sm:mt-20 px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-8 sm:mb-12">Beneficios Clave</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Captura trabajos que normalmente perderías</h3>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Responde más rápido con el mensaje correcto</h3>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Configuración simple — mantén tu número actual</h3>
            </div>
          </div>
        </div>
        ...
        {/* FAQ Section */}
        <div className="mt-16 sm:mt-20 px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-8 sm:mb-12">Preguntas Frecuentes</h2>
          
          <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">¿Necesito cambiar de proveedor telefónico?</h3>
              <p className="text-sm sm:text-base text-gray-600">No. Mantén tu número.</p>
            </div>
            
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">¿Funcionará después del horario laboral?</h3>
              <p className="text-sm sm:text-base text-gray-600">Sí. Podemos pausar o enviar respuestas fuera de horario.</p>
            </div>
            
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">¿Es complicado configurarlo?</h3>
              <p className="text-sm sm:text-base text-gray-600">No. La mayoría de las empresas están funcionando en ~5 minutos.</p>
            </div>
          </div>
        </div>
